        ...
        <ScrollArea className="h-[60vh] px-6">
          <div className="space-y-6 text-sm leading-relaxed text-summit-black">
            ...
            <div>
              ...
              <p className="mb-3">
                NADS collects personal information solely for legitimate
                organizational purposes, which may include but not limited to managing your registration, communication, and other organizational purposes.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                As a general principle, NADS does not share personal data with
            ...
            <div>
              ...
              <p>
                ...
                NADS is committed to upholding your rights as outlined in the
            ...
            <div>
              ...
              <p>
                ...
                <a
                  href="mailto:rc.nads.sei@gmail.com"
